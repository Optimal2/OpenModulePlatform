// File: OpenModulePlatform.Web.ExampleWebAppBlazorModule/Services/ExampleWebAppBlazorModuleAdminRepository.cs
using OpenModulePlatform.Web.ExampleWebAppBlazorModule.ViewModels;
using OpenModulePlatform.Web.Shared.Services;
using Microsoft.Data.SqlClient;

namespace OpenModulePlatform.Web.ExampleWebAppBlazorModule.Services;

/// <summary>
/// Portal-facing repository for the simple web-only example module.
/// </summary>
public sealed class ExampleWebAppBlazorModuleAdminRepository
{
