...
public sealed class HostAgentEngine
{
    ...
    /// them abort the whole HostAgent cycle: the shared <see cref="DeploymentFaults"/> list
    /// plus DbException, because only this outermost copy wraps the database work.
    /// </summary>
