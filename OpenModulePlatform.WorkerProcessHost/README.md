...
- rejects plugins whose generated `omp-worker-plugin.json` requires a newer
  `omp-workerprocesshost` artifact, before loading the assembly or creating its factory
