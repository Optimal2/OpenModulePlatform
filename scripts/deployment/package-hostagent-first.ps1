...
$defaultWebAppDataProtectionKeyPath = [string](Get-ConfigValue -Config $config -Name 'DataProtectionKeyPath' -DefaultValue (Join-DeploymentPath -Root $runtimeRoot -Child 'DataProtectionKeys'))
$webAppDataProtectionKeyPath = [string](Get-ConfigValue -Config $config -Name 'WebAppDataProtectionKeyPath' -DefaultValue $defaultWebAppDataProtectionKeyPath)
$webAppUseForwardedHeaders = [bool](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'UseForwardedHeaders' -DefaultValue $false)
$webAppForwardedHeadersTrustAllProxies = [bool](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'ForwardedHeadersTrustAllProxies' -DefaultValue $false)
$webAppForwardedHeadersKnownProxies = @((Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'ForwardedHeadersKnownProxies' -DefaultValue @()))
$webAppForwardedHeadersKnownNetworks = @((Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'ForwardedHeadersKnownNetworks' -DefaultValue @()))
...
$iisCertificateThumbprint = [string](Get-NestedConfigValue -Config $config -Section 'Iis' -Name 'CertificateThumbprint' -DefaultValue ([string](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'CertificateThumbprint' -DefaultValue '')))
$iisCertificateSerialNumber = [string](Get-NestedConfigValue -Config $config -Section 'Iis' -Name 'CertificateSerialNumber' -DefaultValue ([string](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'CertificateSerialNumber' -DefaultValue '')))
$iisCertificateStoreName = [string](Get-NestedConfigValue -Config $config -Section 'Iis' -Name 'CertificateStoreName' -DefaultValue ([string](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'CertificateStoreName' -DefaultValue 'My')))
...
$hostAgentServiceAccountName = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'ServiceAccountName' -DefaultValue $runAsUser)
$hostAgentServiceAccountPassword = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'ServiceAccountPassword' -DefaultValue $runAsPassword)
$iisAppPoolUserName = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'IisAppPoolUserName' -DefaultValue $runAsUser)
$iisAppPoolPassword = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'IisAppPoolPassword' -DefaultValue $runAsPassword)
$serviceAppUserName = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'ServiceAppUserName' -DefaultValue $hostAgentServiceAccountName)
$serviceAppPassword = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'ServiceAppPassword' -DefaultValue $hostAgentServiceAccountPassword)
$credentialAutomationMode = [string](Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'CredentialAutomationMode' -DefaultValue '')
$iisAppPoolOverrides = Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'IisAppPoolOverrides' -DefaultValue @{}
$serviceAppIdentityOverrides = Get-NestedConfigValue -Config $config -Section 'HostAgent' -Name 'ServiceAppIdentityOverrides' -DefaultValue @{}
...
$sqlTrustServerCertificate = [bool](Get-ConfigValue -Config $config -Name 'SqlTrustServerCertificate' -DefaultValue $false)
$grantRuntimeDatabaseAccess = [bool](Get-NestedConfigValue -Config $config -Section 'Options' -Name 'GrantRunAsDatabaseAccess' -DefaultValue $false)
$includeExampleApps = [bool](Get-NestedConfigValue -Config $config -Section 'Options' -Name 'InstallExamples' -DefaultValue $false)
...
$bootstrapConfig = [ordered]@{
    ...
    sql = [ordered]@{
        ...
        grantRuntimeDatabaseAccess = $grantRuntimeDatabaseAccess
    ...
    hostAgent = [ordered]@{
        ...
        displayName = 'OMP HostAgent'
        description = 'OpenModulePlatform artifact provisioning agent.'
        serviceAccountName = $hostAgentServiceAccountName
        serviceAccountPassword = $hostAgentServiceAccountPassword
        ...
        iisBindingCertificateThumbprint = $iisCertificateThumbprint
        iisBindingCertificateSerialNumber = $iisCertificateSerialNumber
        iisBindingCertificateStoreName = $iisCertificateStoreName
        webAppsRoot = $webAppsRoot
        portalPhysicalPath = $portalPhysicalPath
        iisAppPoolNamePrefix = 'OMP_'
        iisAppPoolUserName = $iisAppPoolUserName
        iisAppPoolPassword = $iisAppPoolPassword
        iisAppPoolOverrides = $iisAppPoolOverrides
        deployServiceApps = $true
        servicesRoot = $servicesRoot
        serviceAppUserName = $serviceAppUserName
        serviceAppPassword = $serviceAppPassword
        serviceAppIdentityOverrides = $serviceAppIdentityOverrides
        credentialStore = [ordered]@{
            automationMode = $credentialAutomationMode
            filePath = ''
        ...
        appSettings = [ordered]@{
            ...
            HostAgent = [ordered]@{
                ...
                WebAppUseForwardedHeaders = $webAppUseForwardedHeaders
                WebAppForwardedHeadersTrustAllProxies = $webAppForwardedHeadersTrustAllProxies
                WebAppForwardedHeadersKnownProxies = @($webAppForwardedHeadersKnownProxies)
                WebAppForwardedHeadersKnownNetworks = @($webAppForwardedHeadersKnownNetworks)
                DeployServiceApps = $true
                ServicesRoot = $servicesRoot
                ServiceAppUserName = $serviceAppUserName
