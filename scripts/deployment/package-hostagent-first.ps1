...
$iisCertificateThumbprint = [string](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'CertificateThumbprint' -DefaultValue '')
$iisCertificateSerialNumber = [string](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'CertificateSerialNumber' -DefaultValue '')
$iisCertificateStoreName = [string](Get-NestedConfigValue -Config $config -Section 'Portal' -Name 'CertificateStoreName' -DefaultValue 'My')
