...
- Script-logic changes to `scripts/omp/bump-version.ps1` or `scripts/omp/validate-component-versions*.ps1`: run `scripts/omp/run-script-tests.ps1` (Pester suites; also blocking in pre-push and CI)
