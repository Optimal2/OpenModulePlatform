...
The scaffold is part of the `0.1.0` public beta baseline, but it is intentionally not feature-complete.

## Purpose

The scaffold prepares OpenModulePlatform for a future runtime model where:
...
- app-specific logic can later be delivered through dedicated worker assemblies
