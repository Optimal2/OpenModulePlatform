...
and is generated by the installer, HostAgent, or artifact configuration-file
rows.
Other bootstrap-only infrastructure without normal OMP app metadata stays as
direct installer payload.
