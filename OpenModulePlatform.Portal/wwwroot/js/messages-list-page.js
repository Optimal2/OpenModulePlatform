// File: OpenModulePlatform.Portal/wwwroot/js/messages-list-page.js
(() => {
    'use strict';
    ...
    const handlePushEvent = (event) => {
        ...
        if (category === MESSAGE_PUSH_CATEGORY && getTopbarConfig().mode === UPDATE_PUSH_MODE) {
            scheduleRefresh(REFRESH_DEBOUNCE_MS);
        }
    };
