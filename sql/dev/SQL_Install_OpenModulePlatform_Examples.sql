...
This legacy-style script keeps the previous one-two local/dev install flow and seeds:
- the default OMP instance, portal, and iframe module defaults
...
- module instances/app instances/template rows for the default OMP instance
